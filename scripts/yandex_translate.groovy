...
def FILENAME = "yandex_translate.groovy"
def KEY = "YANDEX_TRANSLATE"
def TITLE = "Yandex.Translate"
def DOMAIN = "translate.yandex.ru"
...
def updateSourceText = { text ->
    ...
    Platform.runLater(new Runnable() {
        ...
        void run() {
            ...
            String jsCode = "document.getElementById(\"textarea\").value = \"${text}\";" +
...
def projectEventListener = new IProjectEventListener() {
    ...
    void onProjectChanged(IProjectEventListener.PROJECT_CHANGE_TYPE project_change_type) {
        if (project_change_type == IProjectEventListener.PROJECT_CHANGE_TYPE.LOAD ||
            ...
            String url = "http://${DOMAIN}/?lang=${sourceCode}-${targetCode}"
